...
{
    public abstract class RestaurentProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RestaurentProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RestaurentProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RestaurentProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RestaurentProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RestaurentProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RestaurentProjectDbContext, Task<T>> func)
        {
            T result;
